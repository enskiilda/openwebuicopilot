...
const translation = {
  ...
  "An error occurred while fetching the explanation": "Произошла ошибка при получении объяснения",
  Analytics,
  Analyzed,
  ...
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "напр., audio/wav,audio/mpeg,video/* (оставьте пустым для значений по умолчанию)",
  ...
  March,
  Markdown,
  "Markdown (Header)": "Markdown (Заголовок)",
  ...
  "To learn more about powerful prompt variables, click here": "Чтобы узнать больше о мощных переменных промпта, нажмите сюда",
