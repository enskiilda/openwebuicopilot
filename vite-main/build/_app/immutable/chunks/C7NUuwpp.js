...
const translation = {
  ...
  "Allow Chat Deletion": "อนุญาตให้ลบการสนทนา",
  ...
  "An error occurred while fetching the explanation": "เกิดข้อผิดพลาดขณะดึงคำอธิบาย",
  Analytics,
  Analyzed,
  ...
  "CORS must be properly configured by the provider to allow requests from Open WebUI.": "ผู้ให้บริการต้องกำหนดค่า CORS ให้ถูกต้องเพื่ออนุญาตคำขอจาก Open WebUI",
  Create,
  ...
  "Delete All Models": "ลบโมเดลทั้งหมด",
  "Delete Chat": "ลบแชท",
  "Delete chat?": "ลบแชท?",
  ...
  "Discover how to use Open WebUI and seek support from the community.": "เรียนรู้วิธีใช้ Open WebUI และขอความช่วยเหลือจากชุมชน",
  ...
  "Export Config to JSON File": "ส่งออกการตั้งค่าเป็นไฟล์ JSON",
  "Export Models": "",
  "Export Presets": "ส่งออกพรีเซ็ต",
  "Export Prompt Suggestions": "ส่งออกคำแนะนำพรอมต์",
  "Export Prompts": "",
  ...
  "External Tools": "เครื่องมือภายนอก",
  ...
  "Format your variables using brackets like this:": "จัดรูปแบบตัวแปรของคุณโดยใช้วงเล็บเช่นนี้:",
  ...
  "Import Config from JSON File": "นำเข้า Config จากไฟล์ JSON",
  "Import From Link": "นำเข้าโดยใช้ลิงก์",
  "Import Models": "",
  "Import Notes": "นำเข้าบันทึก",
  "Import Presets": "นำเข้าพรีเซ็ต",
  "Import Prompt Suggestions": "นำเข้าคำแนะนำพรอมต์",
  "Import Prompts": "",
  ...
  "Make sure to enclose them with": "ตรวจสอบให้แน่ใจว่าใส่ไว้ภายในเครื่องหมายครอบ",
  ...
  March,
  Markdown,
  "Markdown (Header)": "Markdown (ส่วนหัว)",
  ...
  "No feedbacks found": "ไม่พบความคิดเห็น",
  "No file selected": "ไม่ได้เลือกไฟล์",
  "No functions found": "ไม่พบฟังก์ชัน",
  "No groups with access, add a group to grant access": "ยังไม่มีกลุ่มที่มีสิทธิ์เข้าถึง เพิ่มกลุ่มเพื่อให้สิทธิ์เข้าถึง",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "ขออภัย! คุณกำลังใช้วิธีที่ไม่รองรับ (เฉพาะ Frontend) กรุณาให้บริการ WebUI จากฝั่ง Backend",
  "Open file": "เปิดไฟล์",
  ...
  "Open WebUI can use tools provided by any OpenAPI server.": "Open WebUI สามารถใช้เครื่องมือที่มีให้จากเซิร์ฟเวอร์ OpenAPI ใดก็ได้",
  "Open WebUI uses faster-whisper internally.": "Open WebUI ใช้ faster-whisper อยู่ภายใน",
  "Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.": "Open WebUI ใช้ SpeechT5 และ Embedding เสียงผู้พูด CMU Arctic",
  "Open WebUI version (v{{OPEN_WEBUI_VERSION}}) is lower than required version (v{{REQUIRED_VERSION}})": "เวอร์ชัน Open WebUI (v{{OPEN_WEBUI_VERSION}}) ต่ำกว่าเวอร์ชันที่ต้องการ (v{{REQUIRED_VERSION}})",
  OpenAI,
  ...
  Profile,
  Prompt,
  "Prompt (e.g. Tell me a fun fact about the Roman Empire)": "พรอมต์ (เช่น บอกข้อเท็จจริงที่สนุกเกี่ยวกับจักรวรรดิโรมัน)",
  ...
  "Remove this tag from list": "ลบแท็กนี้ออกจากรายการ",
  Rename,
  ...
  Tiktoken,
  Title,
  "Title (e.g. Tell me a fun fact)": "ชื่อเรื่อง (เช่น บอกข้อมูลสนุกๆ ให้ฉันฟัง)",
  ...
  "To learn more about powerful prompt variables, click here": "หากต้องการเรียนรู้เพิ่มเติมเกี่ยวกับตัวแปรพรอมต์ที่ทรงพลัง คลิกที่นี่",
  "To protect your privacy, only ratings, model IDs, tags, and metadata are shared from your feedback—your chat logs remain private and are not included.": "เพื่อปกป้องความเป็นส่วนตัวของคุณ จะมีการส่งต่อเฉพาะคะแนน ID โมเดล แท็ก และเมทาดาทาจากความคิดเห็นของคุณเท่านั้น โดยบันทึกการแชทของคุณจะยังเป็นความลับและจะไม่ถูกรวมไปด้วย",
  ...
  "Use groups to group your users and assign permissions.": "ใช้กลุ่มเพื่อจัดกลุ่มผู้ใช้และกำหนดสิทธิ์",
  "Use LLM": "ใช้ LLM",
