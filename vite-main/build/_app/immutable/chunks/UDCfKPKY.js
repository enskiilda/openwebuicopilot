...
const Feedbacks = "Geri Bildirimler";
const Female = "";
const File = "Dosya";
...
const translation = {
  ...
  "Click here to see available models.": "Erişilebilir Modelleri Görmek İçin Buraya Tıklayın",
  ...
  "Delete All Models": "Tüm Modelleri Sil",
  ...
  "Oops! There are files still uploading. Please wait for the upload to complete.": "Hop! Hala yüklenen dosyalar var. Yüklemenin tamamlanmasını bekleyin.",
  "Oops! There was an error in the previous response.": "Hop! Önceki yanıtta bir hata oluştu.",
  ...
  "Title Generation Prompt": "Başlık Oluşturma İstemi",
  TLS,
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "[Konuyu veya anahtar kelimeyi] özetleyen 50 kelimelik bir özet yazın.",
