...
const Feedbacks = "Återkopplingar";
const Female = "";
const File = "Fil";
const Files = "Filer";
const Filter = "Filter";
...
const translation = {
  ...
  "Chat Controls": "Chattinställningar",
  ...
  "Default to segmented retrieval for focused and relevant content extraction, this is recommended for most cases.": "Standard till segmenterad hämtning för fokuserad och relevant innehållsextrahering, detta rekommenderas för de flesta fall.",
  ...
  "Delete All Models": "Ta bort alla modeller",
  ...
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "Tvinga OCR på alla sidor i PDF:en. Detta kan leda till sämre resultat om du har bra text i dina PDF:er. Standardvärdet är False.",
  ...
  "Format your variables using brackets like this:": "Du kan använda variabler med hakparenteser så här:",
  ...
  "The developers behind this plugin are passionate volunteers from the community. If you find this plugin helpful, please consider contributing to its development.": "Utvecklarna bakom denna plugin är passionerade volontärer från communityn. Om du tycker att denna plugin är hjälpsam, vänligen överväg att bidra till dess utveckling.",
  ...
  "This feature is experimental and may be modified or discontinued without notice.": "Denna funktion är experimentell och kan ändras eller avslutas utan att meddela.",
  "This is a default user permission and will remain enabled.": "Detta är en standardanvändarbehörighet och kommer att förbli aktiv.",
  ...
  "This option will delete all existing files in the collection and replace them with newly uploaded files.": "Detta alternativ tar bort alla befintliga filer i samlingen och ersätter dem med nyligen uppladdade filer.",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Skriv den prompt du vill återanvända här.",
  ...
  "You do not have permission to send messages in this channel.": "Du har inte behörighet att skicka meddelanden i denna kanal.",
  "You do not have permission to send messages in this thread.": "Du har inte behörighet att skicka meddelanden i denna tråd.",
