...
const Feedbacks = "Ανατροφοδοτήσεις";
...
const translation = {
  ...
  "Discover how to use Open WebUI and seek support from the community.": "Εξερευνήστε πως να χρησιμοποιήσετε το Open WebUI και αναζητήστε βοήθεια στην κοινότητα.",
  ...
  "External Tools": "Εξωτερικά Εργαλεία",
  ...
  March,
  Markdown,
  "Markdown (Header)": "Markdown (Επικεφαλίδα)",
  ...
  "Open WebUI uses SpeechT5 and CMU Arctic speaker embeddings.": "Το Open WebUI χρησιμοποιεί τα SpeechT5 και CMU Arctic ενσωματώσεων ομιλητών.",
  ...
  "Remove this tag from list": "Αφαίρεση αυτής της ετικέτας από τη λίστα",
  Rename,
