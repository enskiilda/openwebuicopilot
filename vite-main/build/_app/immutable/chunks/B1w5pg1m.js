...
const Feedbacks = "Фикр-мулоҳазалар";
const Female = "";
const File = "Файл";
const Files = "Файллар";
const Filter = "";
...
const translation = {
  ...
  "(e.g. `sh webui.sh --api --api-auth username_password`)": "(масалан, `sh webui.sh --api --api-auth username_password`)",
  ...
  "Allow Chat Deletion": "Чатни ўчиришга рухсат беринг",
  ...
  "Default Models": "Стандарт моделлар",
  ...
  "Delete All Models": "Барча моделларни ўчириш",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "Вой! Сиз қўллаб-қувватланмайдиган усулдан фойдаланмоқдасиз (фақат фронтенд). Илтимос, WебУИ-га баcкенд орқали хизмат кўрсатинг.",
  ...
  "This option will delete all existing files in the collection and replace them with newly uploaded files.": "Ушбу параметр тўпламдаги барча мавжуд файлларни ўчиради ва уларни янги юкланган файллар билан алмаштиради.",
  ...
  Tiktoken,
  Title,
  "Title (e.g. Tell me a fun fact)": "Сарлавҳа (масалан, менга қизиқарли фактни айтинг)",
