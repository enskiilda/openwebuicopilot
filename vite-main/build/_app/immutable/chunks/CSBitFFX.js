...
const Capture = "Aufzeichnen";
const Channel = "Kanal";
const Channels = "Kanäle";
const Character = "Zeichen";
const Chat = "Gespräch";
const Chats = "Chats";
const Ciphers = "Verschlüsselungen";
const Citation = "Zitat";
const Citations = "Zitate";
const Clone = "Klonen";
const Close = "Schließen";
const cloud = "Cloud";
const Collapse = "Zuklappen";
const Collection = "Kollektion";
const Color = "Farbe";
...
const Done = "Erledigt";
const Download = "Exportieren";
const Draw = "Zeichnen";
const Edit = "Bearbeiten";
const edited = "bearbeitet";
const Edited = "Bearbeitet";
const Editing = "Bearbeite";
...
const H1 = "Überschrift 1";
const H2 = "Überschrift 2";
const H3 = "Überschrift 3";
...
const translation = {
  ...
  "[Last] dddd [at] h:mm A": "[Zuletzt] dddd [um] h:mm A",
  ...
  "A task model is used when performing tasks such as generating titles for chats and web search queries": "Aufgabenmodelle werden beispielsweise zur Generierung von Chat-Titeln oder Websuchanfragen verwendet",
  "a user": "ein Benutzer",
  About,
  ...
  "Allow Chat Params": "Parameter für Chats erlauben",
  ...
  "Allow Regenerate Response": "Antwort neu generieren erlauben",
  ...
  "An error occurred while fetching the explanation": "Ein Fehler ist beim Abrufen der Erklärung aufgetreten",
  Analytics,
  Analyzed,
  ...
  "Click here to select": "Klicken Sie hier zum Auswählen.",
  ...
  "Click here to upload a workflow.json file.": "Klicken Sie hier, um eine workflow.json-Datei hochzuladen.",
  "click here.": "hier klicken.",
  ...
  "Close Configure Connection Modal": "Konfigurationsfenster für Verbindung schließen",
  "Close modal": "Modal schließen",
  "Close Modal": "Modal schließen",
  "Close settings modal": "Einstellungsfenster schließen",
  ...
  "Code Interpreter Prompt Template": "Code Interpreter Prompt Vorlage",
  Collapse,
  Collection,
  Color,
  ComfyUI,
  ...
  "Comma separated Node Ids (e.g. 1 or 1,2)": "Durch Komma getrennte Knoten-IDs (z. B. 1 oder 1,2)",
  Command,
  Comment,
  Completions,
  ...
  "Connect to your own OpenAPI compatible external tool servers.": "Verbinden Sie sich zu Ihren OpenAPI-kompatiblen Werkzeug-Servern.",
  ...
  Content,
  "Content Extraction Engine": "Inhalts-Extraktions-Engine",
  ...
  "Create your first note by clicking on the plus button below.": "Erstellen Sie Ihre erste Notiz, indem Sie unten auf die Plus-Schaltfläche klicken.",
  ...
  December,
  "Decrease UI Scale": "UI-Größe verringern",
  Deepgram,
  Default,
  ...
  "Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.": 'Bildextraktion aus dem PDF deaktivieren. Wenn "LLM verwenden" aktiviert ist, werden Bilder automatisch beschriftet. Standardmäßig auf False gesetzt.',
  Disabled,
  ...
  "e.g., audio/wav,audio/mpeg,video/* (leave blank for defaults)": "z. B. audio/wav,audio/mpeg,video/* (leer lassen für Standardwerte)",
  ...
  "Enable Mirostat sampling for controlling perplexity.": "Mirostat-Sampling zur Kontrolle der Perplexity aktivieren.",
  ...
  'Enter additional headers in JSON format (e.g. {"X-Custom-Header": "value"}': 'Gib zusätzliche Header im JSON Format ein (z.B. {"X-Custom-Header": "value"}',
  ...
  "Enter Bocha Search API Key": "Geben Sie den Bocha Search API-Schlüssel ein",
  ...
  "Enter domains separated by commas (e.g., example.com,site.org,!excludedsite.com)": "Kommaseparierte Domainnamen eingeben (z.B., erlaubteseite.com,!gesperrteseite.org)",
  ...
  "Enter External Web Loader API Key": "API-Schlüssel für externen Web-Loader eingeben",
  "Enter External Web Loader URL": "URL für externen Web-Loader eingeben",
  "Enter External Web Search API Key": "API-Schlüssel für externe Websuche eingeben",
  ...
  "Enter MinerU API Key": "Geben Sie den MinerU API-Schlüssel ein",
  "Enter Mistral API Base URL": "Mistral API URL eingeben",
  ...
  "Enter SerpApi API Key": "Geben Sie den SerpApi API-Schlüssel ein",
  "Enter SerpApi Engine": "SerpApi-Engine eingeben",
  "Enter Serper API Key": "Geben Sie den Serper-API-Schlüssel ein",
  "Enter Serply API Key": "Geben Sie den Serply API-Schlüssel ein",
  ...
  "Enter your gender": "Geben Sie Ihr Geschlecht ein",
  ...
  "Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.": "Fehler: Ein Modell mit der ID '{{modelId}}' existiert bereits. Bitte wählen Sie eine andere ID, um fortzufahren.",
  "Error: Model ID cannot be empty. Please enter a valid ID to proceed.": "Fehler: Die Modell-ID darf nicht leer sein. Bitte geben Sie eine gültige ID ein, um fortzufahren.",
  Evaluations,
  Everyone,
  ...
  "External Web Loader API Key": "Externer Web-Loader API-Schlüssel",
  ...
  "Focus Chat Input": "Chat Inhalt fokussieren",
  Folder,
  ...
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "OCR für alle Seiten des PDF erzwingen. Dies kann zu schlechteren Ergebnissen führen, wenn bereits guter Text in Ihren PDFs vorhanden ist. Standardwert ist False.",
  "Forge new paths": "Neue Wege beschreiten",
  Form,
  "Format Lines": "Zeilen formatieren",
  "Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.": "Zeilen in der Ausgabe formatieren. Standardwert ist False. Wenn auf True gesetzt, werden die Zeilen formatiert, um mathematische Formeln und Stile zu erkennen.",
  "Format your variables using brackets like this:": "Formatieren Sie Ihre Variablen mit Klammern, wie hier:",
  "Formatting may be inconsistent from source.": "Die Formatierung kann inkonsistent mit der Quelle sein.",
  ...
  "Increase UI Scale": "UI-Größe erhöhen",
  ...
  Input,
  "Input Key (e.g. text, unet_name, steps)": "Eingabe Schlüssel (z.B. text, unet_name, steps)",
  "Input Variables": "Eingabe Variablen",
  Insert,
  "Insert Follow-Up Prompt to Input": "Folgefrage in Eingabe einfügen",
  "Insert Prompt as Rich Text": "Prompt als Rich Text einfügen",
  "Insert Suggestion Prompt to Input": "Prompt-Vorschlag in Eingabe einfügen",
  ...
  "Invalid JSON format in MinerU Parameters": "Ungültiges JSON Format in MinerU Parameter",
  ...
  March,
  Markdown,
  "Markdown (Header)": "Markdown (Überschrift)",
  "Max Speakers": "Maximale Anzahl der Sprecher",
  ...
  MinerU,
  "MinerU API Key required for Cloud API mode.": "MinerU API-Schlüssel erforderlich für den Cloud-API-Modus.",
  ...
  "No expiration can pose security risks.": "Keine Ablauffrist zu setzen kann Sicherheitsrisiken bergen.",
  ...
  "Remember Dismissal": "Ablehnung merken",
  Remove,
  ...
  "Scroll On Branch Change": "Beim Wechseln des Zweigs scrollen",
  Search,
  ...
  "Select a conversation to preview": "Wählen Sie eine Unterhaltung zur Vorschau aus",
  ...
  "Select a model (optional)": "Wählen Sie ein Modell (optional)",
  ...
  "Select an embedding model engine": "Wählen Sie eine Embedding-Modell-Engine aus",
  "Select an engine": "Engine auswählen",
  "Select an Ollama instance": "Wählen Sie eine Ollama-Instanz",
  "Select an output format": "Wählen Sie ein Ausgabeformat aus",
  "Select dtype": "Wählen Sie dtype aus",
  ...
  "Show Shortcuts": "Shortcuts anzeigen",
  ...
  "Sink List": "Senkenliste",
  "sk-1234": "sk-1234",
  "Skip Cache": "Cache ignorieren",
  "Skip the cache and re-run the inference. Defaults to False.": "Cache ignorieren und die Inferenz erneut ausführen. Standardmäßig deaktiviert.",
  ...
  Steps,
  Stop,
  "Stop Generating": "Generation beenden",
  ...
  "Temporary Chat by Default": "Temporäre Unterhaltung standardmäßig",
  ...
  "The format to return a response in. Format can be json or a JSON schema.": "Das Format, in dem eine Antwort zurückgegeben wird. Das Format kann JSON oder ein JSON-Schema sein.",
  "The height in pixels to compress images to. Leave empty for no compression.": "Die Höhe in Pixeln, auf die Bilder komprimiert werden sollen. Leer lassen, um keine Komprimierung durchzuführen.",
  "The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.": "Die Sprache des Eingangsaudios. Die Angabe der Eingangssprache im ISO-639-1-Format (z. B. en) verbessert die Genauigkeit und verringert die Latenz. Leer lassen, um die Sprache automatisch zu erkennen.",
  ...
  "The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.": "Das Ausgabeformat für den Text. Kann 'json', 'markdown' oder 'html' sein. Standardmäßig auf 'markdown' gesetzt.",
  "The passwords you entered don't quite match. Please double-check and try again.": "Die eingegebenen Passwörter stimmen nicht überein. Bitte überprüfen Sie sie erneut und versuchen Sie es noch einmal.",
  ...
  "Toggle whether current connection is active.": "Aktuelle Verbindung umschalten.",
  Token,
  ...
  "Use /v1/chat/completions endpoint instead of /v1/audio/transcriptions for potentially better accuracy.": "Verwende den /v1/chat/completions Endpunkt statt dem /v1/audio/transcriptions Endpunkt für möglicherweise bessere Genauigkeit",
  "Use Chat Completions API": "Verwende Chat Completions API",
  ...
  "Validate certificate": "Zertifikat überprüfen",
  Valves,
  ...
  "Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.": "Ob die Ausgabe paginiert werden soll. Jede Seite wird durch eine horizontale Linie und eine Seitenzahl getrennt. Standardmäßig deaktiviert.",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Schreibe eine kurze Zusammenfassung in 50 Wörtern, die [Thema oder Schlüsselwort] zusammenfasst.",
