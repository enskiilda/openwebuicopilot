...
const translation = {
  ...
  "Allow Chat System Prompt": "Luba vestluse süsteemivihje",
  ...
  "Always Play Notification Sound": "Mängi teavituse heli alati",
  Amazing,
  ...
  "Base Model List Cache speeds up access by fetching base models only at startup or on settings save—faster, but may not show recent base model changes.": "Baasmudelite nimekirja vahemälu kiirendab ligipääsu, tuues baasmudelid ainult käivitamisel või seadete salvestamisel—kiirem, kuid ei pruugi näidata hiljutisi muudatusi.",
  Bearer,
  before,
  ...
  "Chat Conversation": "Vestlus Conversation",
  "Chat direction": "Vestluse suund",
  "Chat ID": "Vestlus ID",
  "Chat moved successfully": "Vestlus moved successfully",
  ...
  "Code Interpreter Prompt Template": "Koodi interpretaatori vihje mall",
  Collapse,
  Collection,
  Color,
  ComfyUI,
  ...
  "Connect to your own OpenAPI compatible external tool servers.": "Connect kuni your own OpenAPI compatible väline tööriist servers.",
  ...
  "Delete All Models": "Kustuta kõik mudelid",
  ...
  "Disable image extraction from the PDF. If Use LLM is enabled, images will be automatically captioned. Defaults to False.": "Keela pilt extraction alates the PDF. If Use LLM is enabled, pildid will be automatically captioned. Defaults kuni False.",
  Disabled,
  ...
  Display,
  "Display chat title in tab": "Display vestlus title in tab",
  ...
  'Enable, disable, or customize the reasoning tags used by the model. "Enabled" uses default tags, "Disabled" turns off reasoning tags, and "Custom" lets you specify your own start and end tags.': 'Luba, keela, või customize the reasoning sildid used autor the mudel. "Enabled" uses vaikimisi sildid, "Disabled" turns off reasoning sildid, ja "Custom" lets you specify your own käivita ja end sildid.',
  Enabled,
  "End Tag": "End Silt",
  ...
  "Enter External Web Loader API Key": "Enter Väline Veeb Loader API Võti",
  "Enter External Web Loader URL": "Enter Väline Veeb Loader URL",
  "Enter External Web Search API Key": "Enter Väline Veeb Otsi API Võti",
  "Enter External Web Search URL": "Enter Väline Veeb Otsi URL",
  ...
  "Enter hex color (e.g. #FF0000)": "Enter hex värv (e.g. #FF0000)",
  "Enter ID": "Enter ID",
  ...
  "Enter Mistral API Key": "Enter Mistral API Võti",
  ...
  "Enter name": "Enter nimi",
  "Enter New Password": "Enter New Parool",
  ...
  "Enter Sougou Search API sID": "Enter Sougou Otsi API sID",
  "Enter Sougou Search API SK": "Enter Sougou Otsi API SK",
  ...
  "Enter the URL of the function to import": "Enter the URL - the function kuni impordi",
  "Enter the URL to import": "Enter the URL kuni impordi",
  ...
  "Enter value (true/false)": "Enter value (true/false)",
  "Enter Yacy Password": "Enter Yacy Parool",
  ...
  "Enter your gender": "Enter your sugu",
  "Enter your message": "Sisestage oma sõnum",
  "Enter your name": "Enter your nimi",
  "Enter Your Name": "Enter Your Nimi",
  ...
  "Error": "Viga",
  ERROR,
  "Error accessing directory": "Viga accessing directory",
  "Error accessing Google Drive: {{error}}": "Viga Google Drive'i juurdepääsul: {{error}}",
  "Error accessing media devices.": "Viga accessing media devices.",
  "Error starting recording.": "Viga starting recording.",
  "Error unloading model: {{error}}": "Viga unloading mudel: {{error}}",
  "Error uploading file: {{error}}": "Viga faili üleslaadimisel: {{error}}",
  "Error: A model with the ID '{{modelId}}' already exists. Please select a different ID to proceed.": "Viga: A mudel koos the ID '{{modelId}}' already exists. Please select a different ID kuni proceed.",
  "Error: Model ID cannot be empty. Please enter a valid ID to proceed.": "Viga: Mudel ID cannot be empty. Please enter a valid ID kuni proceed.",
  Evaluations,
  Everyone,
  ...
  "External Tools": "Välised tööriistad",
  ...
  "Failed to extract content from the file: {{error}}": "Ebaõnnestus kuni extract content alates the fail: {{error}}",
  "Failed to extract content from the file.": "Ebaõnnestus kuni extract content alates the fail.",
  ...
  "Failed to save connections": "Ebaõnnestus kuni salvesta connections",
  ...
  "Feedback Details": "Tagasiside Details",
  ...
  "Follow Up Generation Prompt": "Järelküsimuse vihje",
  ...
  "Force OCR": "Sunni OCR",
  "Force OCR on all pages of the PDF. This can lead to worse results if you have good text in your PDFs. Defaults to False.": "Force OCR peal all lehed - the PDF. This can lead kuni worse results if you have hea text in your PDFs. Defaults kuni False.",
  "Forge new paths": "Loo uusi radu",
  Form,
  "Format Lines": "Vorminda read",
  "Format the lines in the output. Defaults to False. If set to True, the lines will be formatted to detect inline math and styles.": "Format the rida in the output. Defaults kuni False. If set kuni True, the rida will be formatted kuni detect inline math ja styles.",
  ...
  "Forwards system user session credentials to authenticate": "Edastab süsteemikasutaja seansikreendid autentimiseks",
  ...
  "Function imported successfully": "Function imported successfully",
  ...
  "Image Max Compression Size width": "Pildi maksimaalne tihendusla(i)us",
  "Image Prompt Generation": "Pildi vihje genereerimine",
  "Image Prompt Generation Prompt": "Pildi vihje genereerimise vihje",
  "Image Size": "",
  Images,
  Import,
  ...
  Insert,
  "Insert Follow-Up Prompt to Input": "Sisesta järelküsimuse vihje sisendisse",
  "Insert Prompt as Rich Text": "Sisesta vihje rikastekstina",
  "Insert Suggestion Prompt to Input": "Sisesta soovitusvihje sisendisse",
  ...
  "Keep Follow-Up Prompts in Chat": "Keep Follow-Up Prompts in Vestlus",
  ...
  "Learn more about OpenAPI tool servers.": "Learn more about OpenAPI tööriist servers.",
  "Learn more about Voxtral transcription.": "",
  "Leave empty for no compression": "Leave empty for no compression",
  "Leave empty for unlimited": "Jäta tühjaks piiranguta kasutamiseks",
  'Leave empty to include all models from "{{url}}" endpoint': 'Leave empty kuni include all mudelid alates "{{url}}" lõpp-punkt',
  'Leave empty to include all models from "{{url}}/api/tags" endpoint': 'Leave empty kuni include all mudelid alates "{{url}}/api/sildid" lõpp-punkt',
  'Leave empty to include all models from "{{url}}/models" endpoint': 'Leave empty kuni include all mudelid alates "{{url}}/mudelid" lõpp-punkt',
  ...
  local,
  Local,
  "Local Task Model": "Kohalik Task Mudel",
  ...
  "Model {{name}} is now hidden": "Mudel {{name}} is now peidetud",
  "Model {{name}} is now visible": "Mudel {{name}} is now visible",
  ...
  "Model ID": "Mudeli ID",
  "Model ID is required.": "Mudel ID is required.",
  "Model IDs": "Mudeli ID-d",
  "Model Name": "Mudeli nimi",
  "Model name already exists, please choose a different one": "Mudel nimi already exists, please choose a different one",
  "Model Name is required.": "Mudel Nimi is required.",
  "Model not selected": "Mudel pole valitud",
  "Model Params": "Mudeli parameetrid",
  "Model Permissions": "Mudeli õigused",
  "Model unloaded successfully": "Mudel unloaded successfully",
  ...
  "No conversation to save": "No conversation kuni salvesta",
  ...
  "No Notes": "No Märkmed",
  "No notes found": "No märkmed found",
  ...
  "No tools found": "No tööriista found",
  ...
  Note,
  "Note deleted successfully": "Märge deleted successfully",
  ...
  Notes,
  "Notes Public Sharing": "Märkmed Avalik Sharing",
  "Notes Sharing": "",
  ...
  "Only markdown files are allowed": "Only markdown failid are allowed",
  ...
  "Open link": "Ava link",
  "Open modal to configure connection": "Ava modal kuni configure connection",
  "Open Modal To Manage Floating Quick Actions": "Ava Modal Kuni Manage Floating Quick Actions",
  "Open Modal To Manage Image Compression": "Ava Modal Kuni Manage Pilt Compression",
  "Open Settings": "",
  "Open Sidebar": "Ava Sidebar",
  "Open User Profile Menu": "Ava Kasutaja Profile Menu",
  "Open WebUI can use tools provided by any OpenAPI server.": "Ava WebUI can use tööriista provided autor any OpenAPI server.",
  ...
  "Please enter a message or attach a file.": "Please enter a sõnum või attach a fail.",
  "Please enter a prompt": "Palun sisestage vihje",
  "Please enter a valid ID": "Please enter a valid ID",
  "Please enter a valid JSON spec": "Please enter a valid JSON spec",
  "Please enter a valid path": "Please enter a valid path",
  "Please enter a valid URL": "Please enter a valid URL",
  "Please enter a valid URL.": "Please enter a valid URL.",
  "Please fill in all fields.": "Palun täitke kõik väljad.",
  "Please register the OAuth client": "Please registreeru the OAuth client",
  "Please save the connection to persist the OAuth client information and do not change the ID": "Please salvesta the connection kuni persist the OAuth client information ja do not change the ID",
  ...
  "Previous message": "Previous sõnum",
  Private,
  Profile,
  Prompt,
  ...
  "Prompt Content": "Vihje sisu",
  "Prompt created successfully": "Vihje edukalt loodud",
  "Prompt updated successfully": "Vihje edukalt uuendatud",
  Prompts,
  "Prompts Access": "Vihjete juurdepääs",
  "Prompts Public Sharing": "Prompts Avalik Sharing",
  "Prompts Sharing": "",
  ...
  "Reasoning Tags": "Reasoning Sildid",
  Record,
  ...
  "Reference Chats": "Reference Vestlused",
  "Refused when it shouldn't have": "Keeldus, kui ei oleks pidanud",
  Regenerate,
  "Regenerate Menu": "Regenerate Menu",
  "Regenerate Response": "",
  "Register Again": "Registreeru Again",
  "Register Client": "Registreeru Client",
  Registered,
  "Registration failed": "Registration ebaõnnestus",
  "Registration successful": "Registration successful",
  Reindex,
  "Reindex Knowledge Base Vectors": "Reindex Teadmised Base Vectors",
  "Release Notes": "Väljalaskemärkmed",
  Releases,
  Relevance,
  "Relevance Threshold": "Relevance Threshold",
  "Remember Dismissal": "Remember Dismissal",
  Remove,
  "Remove {{MODELID}} from list.": "Eemalda {{MODELID}} alates list.",
  "Remove file": "Eemalda fail",
  "Remove File": "Eemalda Fail",
  "Remove image": "Eemalda pilt",
  "Remove Model": "Eemalda mudel",
  "Remove this tag from list": "Eemalda this silt alates list",
  Rename,
  ...
  "Retrieved {{count}} sources": "Retrieved {{count}} allikad",
  ...
  "Scroll On Branch Change": "Scroll Peal Branch Change",
  Search,
  "Search a model": "Otsi mudelit",
  "Search all emojis": "Otsi all emojis",
  "Search Base": "Otsingu baas",
  "Search Chats": "Otsi vestlusi",
  "Search Collection": "Otsi kogust",
  "Search Filters": "Otsingu filtrid",
  "search for archived chats": "otsi for arhiveeritud vestlused",
  "search for folders": "otsi for kaustad",
  "search for pinned chats": "otsi for pinned vestlused",
  "search for shared chats": "otsi for shared vestlused",
  "search for tags": "otsi silte",
  "Search Functions": "Otsi funktsioone",
  "Search In Models": "Otsi In Mudelid",
  "Search Knowledge": "Otsi teadmisi",
  "Search Models": "Otsi mudeleid",
  "Search Notes": "Otsi Märkmed",
  ...
  "Searching the web": "Searching the veeb",
  ...
  "Select a base model (e.g. llama3, gpt-4o)": "Select a base mudel (e.g. llama3, gpt-4o)",
  "Select a conversation to preview": "Select a conversation kuni preview",
  "Select a engine": "Valige mootor",
  "Select a function": "Valige funktsioon",
  "Select a group": "Valige grupp",
  "Select a language": "Select a keel",
  "Select a mode": "Select a mode",
  "Select a model": "Valige mudel",
  "Select a model (optional)": "Select a mudel (optional)",
  "Select a pipeline": "Valige torustik",
  "Select a pipeline url": "Valige torustiku URL",
  "Select a reranking model engine": "Select a reranking mudel engine",
  "Select a role": "Select a roll",
  "Select a theme": "Select a theme",
  "Select a tool": "Valige tööriist",
  "Select a voice": "Select a hääl",
  "Select an auth method": "Valige autentimismeetod",
  "Select an embedding model engine": "Select an embedding mudel engine",
  ...
  "Select how to split message text for TTS requests": "Select how kuni split sõnum text for TTS requests",
  "Select Knowledge": "Valige teadmised",
  "Select Method": "",
  "Select only one model to call": "Valige ainult üks mudel kutsumiseks",
  "Select view": "Select vaata",
  ...
  "Sets the random number seed to use for generation. Setting this to a specific number will make the model generate the same text for the same prompt.": "Määrab genereerimiseks kasutatava juhusliku arvu seemne. Selle määramine kindlale numbrile paneb mudeli genereerima sama teksti sama vihje korral.",
  ...
  "Share your background and interests": "Jaga your background ja interests",
  "Shared with you": "Shared koos you",
  "Sharing Permissions": "Sharing Õigused",
  Show,
  ...
  "Sign in": "Logi sisse",
  "Sign in to {{WEBUI_NAME}}": "Logi sisse {{WEBUI_NAME}}",
  "Sign in to {{WEBUI_NAME}} with LDAP": "Logi sisse {{WEBUI_NAME}} LDAP-ga",
  "Sign Out": "Logi välja",
  "Sign up": "Registreeru",
  "Sign up to {{WEBUI_NAME}}": "Registreeru {{WEBUI_NAME}}",
  "Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.": "Significantly improves accuracy autor using an LLM kuni enhance tables, forms, inline math, ja layout detection. Will increase latency. Defaults kuni False.",
  ...
  "Sougou Search API sID": "Sougou Otsi API sID",
  "Sougou Search API SK": "Sougou Otsi API SK",
  Source,
  ...
  "Strip existing OCR text from the PDF and re-run OCR. Ignored if Force OCR is enabled. Defaults to False.": "Strip existing OCR text alates the PDF ja re-run OCR. Ignored if Force OCR is enabled. Defaults kuni False.",
  "STT Model": "STT mudel",
  "STT Settings": "STT seaded",
  "Stylized PDF Export": "Stylized PDF Ekspordi",
  "Subtitle (e.g. about the Roman Empire)": "Alampealkiri (nt Rooma impeeriumi kohta)",
  Success,
  "Successfully imported {{userCount}} users.": "Successfully imported {{userCount}} kasutajat.",
  ...
  "Temporary Chat by Default": "Temporary Vestlus autor Vaikimisi",
  ...
  "The format to return a response in. Format can be json or a JSON schema.": "The format kuni return a vastus in. Format can be json või a JSON schema.",
  "The height in pixels to compress images to. Leave empty for no compression.": "The kõrgus in pixels kuni compress pildid kuni. Leave empty for no compression.",
  "The language of the input audio. Supplying the input language in ISO-639-1 (e.g. en) format will improve accuracy and latency. Leave blank to automatically detect the language.": "The keel - the input heli. Supplying the input keel in ISO-639-1 (e.g. en) format will improve accuracy ja latency. Leave blank kuni automatically detect the keel.",
  ...
  "The output format for the text. Can be 'json', 'markdown', or 'html'. Defaults to 'markdown'.": "The output format for the text. Can be 'json', 'markdown', või 'html'. Defaults kuni 'markdown'.",
  "The passwords you entered don't quite match. Please double-check and try again.": "The passwords you entered don't quite match. Please double-check ja proovi again.",
  "The score should be a value between 0.0 (0%) and 1.0 (100%).": "Skoor peaks olema väärtus vahemikus 0,0 (0%) kuni 1,0 (100%).",
  "The stream delta chunk size for the model. Increasing the chunk size will make the model respond with larger pieces of text at once.": "The stream delta chunk size for the mudel. Increasing the chunk size will make the mudel respond koos larger pieces - text kell once.",
  ...
  "The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5": "The Weight - BM25 Hybrid Otsi. 0 more semantic, 1 more lexical. Vaikimisi 0.5",
  "The width in pixels to compress images to. Leave empty for no compression.": "The laius in pixels kuni compress pildid kuni. Leave empty for no compression.",
  Theme,
  "Thinking...": "Mõtleb...",
  "This action cannot be undone. Do you wish to continue?": "Seda toimingut ei saa tagasi võtta. Kas soovite jätkata?",
  "This channel was created on {{createdAt}}. This is the very beginning of the {{channelName}} channel.": "This channel was created peal {{createdAt}}. This is the very beginning - the {{channelName}} channel.",
  "This chat won't appear in history and your messages will not be saved.": "This vestlus won't appear in ajalugu ja your sõnumid will not be saved.",
  ...
  "This feature is experimental and may be modified or discontinued without notice.": "This funktsioon is katsetuslik ja mai be modified või discontinued without notice.",
  "This is a default user permission and will remain enabled.": "This is a vaikimisi kasutaja õigus ja will remain enabled.",
  ...
  "This model is not publicly available. Please select another model.": "This mudel is not publicly saadaval. Please select another mudel.",
  "This option controls how long the model will stay loaded into memory following the request (default: 5m)": "This option controls how long the mudel will stay loaded into mälu following the päring (default: 5m)",
  ...
  "This option enables or disables the use of the reasoning feature in Ollama, which allows the model to think before generating a response. When enabled, the model can take a moment to process the conversation context and generate a more thoughtful response.": "This option enables või disables the use - the reasoning funktsioon in Ollama, which allows the mudel kuni think before generating a vastus. When enabled, the mudel can take a moment kuni process the conversation context ja generate a more thoughtful vastus.",
  ...
  "Thought for less than a second": "Thought for less than a second",
  Thread,
  Tika,
  ...
  "Title Generation Prompt": "Pealkirja genereerimise vihje",
  TLS,
  ...
  "To learn more about powerful prompt variables, click here": "Kuni learn more about powerful prompt variables, click here",
  ...
  "Tools Public Sharing": "Tööriista Avalik Sharing",
  "Tools Sharing": "",
  "Top K": "Top K",
  ...
  "Try adjusting your search or filter to find what you are looking for.": "Proovi adjusting your otsi või filter kuni find what you are looking for.",
  "Try Again": "Proovi Again",
  "TTS Model": "TTS mudel",
  ...
  Underline,
  Unknown,
  "Unknown User": "Unknown Kasutaja",
  "Unloads {{FROM_NOW}}": "Unloads {{FROM_NOW}}",
  "Unlock mysteries": "Ava mõistatused",
  Unpin,
  "Unravel secrets": "Ava saladused",
  "Unsupported file type.": "Unsupported fail type.",
  Untagged,
  Untitled,
  Update,
  ...
  "Upload Audio": "Laadi Heli",
  "Upload directory": "Üleslaadimise kataloog",
  "Upload files": "Laadi failid üles",
  "Upload Files": "Laadi failid üles",
  "Upload Model": "Laadi Mudel",
  "Upload Pipeline": "Laadi torustik üles",
  "Upload Progress": "Üleslaadimise progress",
  "Upload Progress: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)": "Laadi Edenemine: {{uploadedFiles}}/{{totalFiles}} ({{percentage}}%)",
  "Uploading file...": "",
  URL,
  ...
  "Use LLM": "Use LLM",
  "Use no proxy to fetch page contents.": "Use no puhverserver kuni fetch leht contents.",
  "Use proxy designated by http_proxy and https_proxy environment variables to fetch page contents.": "Use puhverserver designated autor http_puhverserver ja https_puhverserver environment variables kuni fetch leht contents.",
  user,
  User,
  "User Groups": "Kasutaja Groups",
  ...
  "Using Entire Document": "Using Entire Dokument",
  ...
  Web,
  "Web API": "Veebi API",
  "Web Loader Engine": "Veeb Loader Engine",
  ...
  "WebUI URL": "WebUI URL",
  'WebUI will make requests to "{{url}}"': 'WebUI will make requests kuni "{{url}}"',
  ...
  "Whether to paginate the output. Each page will be separated by a horizontal rule and page number. Defaults to False.": "Whether kuni paginate the output. Each leht will be separated autor a horizontal rule ja leht number. Defaults kuni False.",
  ...
  Write,
  "Write a summary in 50 words that summarizes {{topic}}.": "Kirjutage 50-sõnaline kokkuvõte, mis võtab kokku [teema või märksõna].",
  ...
  "You do not have permission to send messages in this channel.": "You do not have õigus kuni send sõnumid in this channel.",
  "You do not have permission to send messages in this thread.": "You do not have õigus kuni send sõnumid in this thread.",
