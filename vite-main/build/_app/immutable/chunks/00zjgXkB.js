...
const translation = {
  ...
  Amazing,
  "an assistant": "一个助手",
  "An error occurred while fetching the explanation": "获取解释时发生错误",
  Analytics,
  Analyzed,
  "Analyzing...": "正在分析...",
  and,
  ...
  "Google PSE API Key": "Google PSE 接口密钥",
  ...
  "To protect your privacy, only ratings, model IDs, tags, and metadata are shared from your feedback—your chat logs remain private and are not included.": "为了保护您的隐私，只有评分、模型 ID、标签和元数据会从您的反馈中分享——您的对话记录将保持私密，不会被包含在内。",
