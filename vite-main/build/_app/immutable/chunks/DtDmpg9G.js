...
import { L as convertOpenApiToToolPayload } from "./Bh-hrM1w.js";
import { a as getOpenAIModelsDirect } from "./Bm2W_wlw.js";
import { Y as YAMLMap, i as isMap, a as YAMLSeq, b as isSeq, s as stringifyString, S as Scalar, m as merge, o as omap, p as pairs, c as set, M as MAP, d as SCALAR, e as SEQ, f as createStringifyContext, g as indentComment, h as isNode, j as stringify, l as lineComment, N as NODE_TYPE, D as DOC, k as Directives, n as anchorNames, q as findNewAnchor, A as Alias, r as createNode, t as createNodeAnchors, u as isCollection, P as Pair, v as isEmptyPath, w as isScalar, x as collectionFromPath, y as toJS, z as applyReviver, B as isPair, L as Lexer, C as tokenType, E as warn } from "./-BrZk0Qz.js";
import "./DKem_M_z.js";
import "./DwLkIEu4.js";
import "./BccDN__m.js";
const map = {
...
const generateAutoCompletion = async (token = "", model, prompt, messages, type = "search query") => {
  var _a, _b;
...
export {
  getTaskConfig as A,
  updateTaskConfig as B,
  getBackendConfig as a,
  getToolServerData as b,
  getUsage as c,
  generateTags as d,
  generateAutoCompletion as e,
  generateEmoji as f,
  getModels as g,
  getTaskIdsByChatId as h,
  chatCompleted as i,
  chatAction as j,
  generateMoACompletion as k,
  generateTitle as l,
  getVersionUpdates as m,
  getToolServersData as n,
  getChangelog as o,
  getWebhookUrl as p,
  getPipelinesList as q,
  updatePipelineValves as r,
  stopTask as s,
  getPipelines as t,
  updateWebhookUrl as u,
  getPipelineValvesSpec as v,
  getPipelineValves as w,
  uploadPipeline as x,
  downloadPipeline as y,
  deletePipeline as z
};
