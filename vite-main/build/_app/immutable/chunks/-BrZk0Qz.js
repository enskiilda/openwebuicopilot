...
function createNode(value, tagName, ctx) {
  ...
  if (isNode(value))
    return value;
  if (isPair(value)) {
    const map = (_b = (_a = ctx.schema[MAP]).createNode) == null ? void 0 : _b.call(_a, ctx.schema, null, ctx);
...
const omap = {
  ...
  resolve(seq, onError) {
    const pairs2 = resolvePairs(seq, onError);
    const seenKeys = [];
...
export {
  ...
  findNewAnchor as q,
  createNode as r,
  stringifyString as s,
  createNodeAnchors as t,
  isCollection as u,
  isEmptyPath as v,
  isScalar as w,
  collectionFromPath as x,
  toJS as y,
  applyReviver as z
};
