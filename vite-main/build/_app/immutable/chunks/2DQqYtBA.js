...
const Feedbacks = "Fikr-mulohazalar";
const Female = "";
const File = "Fayl";
const Files = "Fayllar";
const Filter = "";
...
const translation = {
  ...
  "(e.g. `sh webui.sh --api --api-auth username_password`)": "(masalan, `sh webui.sh --api --api-auth username_password`)",
  ...
  "Allow Chat Deletion": "Chatni oʻchirishga ruxsat bering",
  ...
  "Default Models": "Standart modellar",
  ...
  "Delete All Models": "Barcha modellarni o'chirish",
  ...
  "Oops! You're using an unsupported method (frontend only). Please serve the WebUI from the backend.": "Voy! Siz qoʻllab-quvvatlanmaydigan usuldan foydalanmoqdasiz (faqat frontend). Iltimos, WebUI-ga backend orqali xizmat ko'rsating.",
  ...
  "This option will delete all existing files in the collection and replace them with newly uploaded files.": "Ushbu parametr to'plamdagi barcha mavjud fayllarni o'chiradi va ularni yangi yuklangan fayllar bilan almashtiradi.",
  ...
  Tiktoken,
  Title,
  "Title (e.g. Tell me a fun fact)": "Sarlavha (masalan, menga qiziqarli faktni ayting)",
