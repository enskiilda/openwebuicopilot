...
const translation = {
  ...
  "AUTOMATIC1111 Base URL": "AUTOMATIC1111 基底 URL",
  ...
  "ComfyUI Base URL": "ComfyUI 基底 URL",
  ...
  "Follow-Up Auto-Generation": "跟進內容自動生成",
  ...
  "Model can generate images based on text prompts": "模型可基於文字提示詞生成影像",
  ...
  "Please register the OAuth client": "請登錄 OAuth 客戶端",
  ...
  "Significantly improves accuracy by using an LLM to enhance tables, forms, inline math, and layout detection. Will increase latency. Defaults to False.": "借助大語言模型（LLM）提升表格、表單、行內數學公式及版面偵測的準確性，但會增加回應時間。預設值：False。",
  ...
  "The Weight of BM25 Hybrid Search. 0 more semantic, 1 more lexical. Default 0.5": "BM25 混合搜尋權重。0 更語意化，1 更關鍵詞化。預設 0.5",
