...
const translation = {
  ...
  "Adds filenames, titles, sections, and snippets into the BM25 text to improve lexical recall.": "Añade nombres de ficheros, títulos, secciones o fragmentos para mejorar la búsqueda léxica con BM25.",
  ...
  "Failed to extract content from the file: {{error}}": "Fallo al extraer el contenido del fichero: {{error}}",
  ...
  "Prevent File Creation": "Prevenir la Creación de Ficheros",
  Preview,
  ...
  "Unsupported file type.": "Tipo de fichero no soportado",
  Untagged,
  Untitled,
  Update,
  ...
  "Webpage URL": "URL de la Página Web",
