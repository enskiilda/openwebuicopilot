...
const translation = {
  ...
  "Remove this tag from list": "حذف این تگ از لیست",
  Rename,
  ...
  "To learn more about powerful prompt variables, click here": "برای کسب اطلاعات بیشتر در مورد متغیرهای قدرتمند پرامپت، اینجا کلیک کنید",
