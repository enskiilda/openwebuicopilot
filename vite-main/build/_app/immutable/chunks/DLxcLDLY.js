...
const translation = {
  ...
  "Allow Rate Response": "",
  "Allow Regenerate Response": "Autoriser la régénération de la réponse",
  ...
  "Chat ID": "ID de chat",
  "Chat moved successfully": "La conversation a été déplacé avec succès",
  ...
  "Document Intelligence endpoint required.": "Point de terminaison Document Intelligence requis.",
  Documentation,
  Documents,
  ...
  "Error: Model ID cannot be empty. Please enter a valid ID to proceed.": "Erreur : l'identifiant du modèle ne peut pas être vide. Veuillez saisir un identifiant valide pour continuer.",
  Evaluations,
  Everyone,
  ...
  "Prompts Sharing": "",
  "Provider Type": "Tye de fournisseur",
  Public,
  ...
  Regenerate,
  "Regenerate Menu": "Régénérer le menu",
  "Regenerate Response": "",
  "Register Again": "",
  "Register Client": "",
  Registered,
  ...
  Success,
  "Successfully imported {{userCount}} users.": "{{userCount}} utilisateurs ont été importés avec succès.",
  ...
  "To learn more about powerful prompt variables, click here": "Pour en savoir plus sur les variables de prompt puissantes, cliquez ici",
