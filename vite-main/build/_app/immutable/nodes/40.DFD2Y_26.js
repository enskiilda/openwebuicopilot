...
import { p as push, g as getContext, c as child, f as first_child, e as sibling, r as reset, t as template_effect, u as untrack, b as get, h as derived_safe_equal, s as set, m as mutable_source, a as pop, o as onMount, l as legacy_pre_effect, j as legacy_pre_effect_reset, d as deferred_template_effect, $ as $document, k as tick, q as next, i as deep_read_state } from "../chunks/BxIY6ir7.js";
...
import { c as config, u as user, t as tools, W as WEBUI_NAME } from "../chunks/2Yg1sHDo.js";
import { g as goto } from "../chunks/h-B6Md2q.js";
import { l as loadToolByUrl, j as getToolList, g as getTools, c as createNewTool, k as deleteToolById, m as exportTools, a as getToolById } from "../chunks/DloK8TH_.js";
          ...
          children: ($$anchor3, $$slotProps2) => {
            ...
            Menu_item(node_5, {
              ...
              children: ($$anchor4, $$slotProps3) => {
                ...
                DocumentDuplicate(node_6, {});
                var div_3 = sibling(node_6, 2);
                var text_2 = child(div_3, true);
                reset(div_3);
                template_effect(($0) => set_text(text_2, $0), [() => ($i18n(), untrack(() => $i18n().t("Clone")))]);
            ...
            Menu_item(node_9, {
              ...
              children: ($$anchor4, $$slotProps3) => {
                ...
                reset(div_5);
                template_effect(($0) => set_text(text_4, $0), [() => ($i18n(), untrack(() => $i18n().t("Delete")))]);
...
var root_6 = from_html(`<div class=" px-2 py-1.5 rounded-xl bg-black text-white dark:bg-white dark:text-black transition font-medium text-sm flex items-center"><!> <div class=" hidden md:block md:ml-1 text-xs"> </div></div>`);
var root_7 = from_html(`<a class=" px-2 py-1.5 rounded-xl bg-black text-white dark:bg-white dark:text-black transition font-medium text-sm flex items-center" href="/workspace/tools/create"><!> <div class=" hidden md:block md:ml-1 text-xs"> </div></a>`);
var root_8 = from_html(`<div class="self-center pl-1.5 translate-y-[0.5px] rounded-l-xl bg-transparent"><button class="p-0.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-900 transition"><!></button></div>`);
var root_13 = from_html(`<div class=" text-gray-500 text-xs font-medium shrink-0"> </div>`);
var root_12 = from_html(`<div class="flex items-center gap-2"><div class="line-clamp-1 text-sm"> </div> <!></div>`);
...
var root_19 = from_html(`<button class="self-center w-fit text-sm px-2 py-2 dark:text-gray-300 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-xl" type="button"><!></button>`);
var root_20 = from_html(`<button class="self-center w-fit text-sm px-2 py-2 dark:text-gray-300 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-xl" type="button"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4"><path stroke-linecap="round" stroke-linejoin="round" d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.325.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 0 1 1.37.49l1.296 2.247a1.125 1.125 0 0 1-.26 1.431l-1.003.827c-.293.241-.438.613-.43.992a7.723 7.723 0 0 1 0 .255c-.008.378.137.75.43.991l1.004.827c.424.35.534.955.26 1.43l-1.298 2.247a1.125 1.125 0 0 1-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.47 6.47 0 0 1-.22.128c-.331.183-.581.495-.644.869l-.213 1.281c-.09.543-.56.94-1.11.94h-2.594c-.55 0-1.019-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 0 1-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 0 1-1.369-.49l-1.297-2.247a1.125 1.125 0 0 1 .26-1.431l1.004-.827c.292-.24.437-.613.43-.991a6.932 6.932 0 0 1 0-.255c.007-.38-.138-.751-.43-.992l-1.004-.827a1.125 1.125 0 0 1-.26-1.43l1.297-2.247a1.125 1.125 0 0 1 1.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.086.22-.128.332-.183.582-.495.644-.869l.214-1.28Z"></path><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"></path></svg></button>`);
var root_21 = from_html(`<button class="self-center w-fit text-sm p-1.5 dark:text-gray-300 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/5 rounded-xl" type="button"><!></button>`);
var root_17 = from_html(`<!> <!> <!>`, 1);
var root_11 = from_html(`<div class=" flex space-x-4 cursor-pointer text-left w-full px-3 py-2.5 dark:hover:bg-gray-850/50 hover:bg-gray-50 transition rounded-2xl"><a class=" flex flex-1 space-x-3.5 cursor-pointer w-full"><div class="flex items-center text-left"><div class=" flex-1 self-center"><!> <div class="px-0.5"><div class="text-xs text-gray-500 shrink-0"><!></div></div></div></div></a> <div class="flex flex-row gap-0.5 self-center"><!></div></div>`);
var root_9 = from_html(`<div class=" my-2 gap-2 grid px-3 lg:grid-cols-2"></div>`);
var root_22 = from_html(`<div class=" w-full h-full flex flex-col justify-center items-center my-16 mb-24"><div class="max-w-md text-center"><div class=" text-3xl mb-3">😕</div> <div class=" text-lg font-medium mb-1"> </div> <div class=" text-gray-500 text-center text-xs"> </div></div></div>`);
var root_23 = from_html(`<div class=" my-16"><div class=" text-xl font-medium mb-1 line-clamp-1"> </div> <a class=" flex cursor-pointer items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-850 w-full mb-2 px-3.5 py-1.5 rounded-xl transition" href="https://openwebui.com/tools" target="_blank"><div class=" self-center"><div class=" font-medium line-clamp-1"> </div> <div class=" text-sm line-clamp-1"> </div></div> <div><div><!></div></div></a></div>`);
var root_24 = from_html(`<div class=" text-sm text-gray-500 truncate"> <span class="  font-medium"> </span>.</div>`);
var root_25 = from_html(`<div class="text-sm text-gray-500"><div class=" bg-yellow-500/20 text-yellow-700 dark:text-yellow-200 rounded-lg px-4 py-3"><div> </div> <ul class=" mt-1 list-disc pl-4 text-xs"><li> </li> <li> </li></ul></div> <div class="my-3"> </div></div>`);
var root_2 = from_html(`<div class="flex flex-col gap-1 px-1 mt-1.5 mb-3"><input id="documents-import-input" type="file" accept=".json" hidden=""/> <div class="flex justify-between items-center"><div class="flex items-center md:self-center text-xl font-medium px-0.5 gap-2 shrink-0"><div> </div> <div class="text-lg font-medium text-gray-500 dark:text-gray-500"> </div></div> <div class="flex w-full justify-end gap-1.5"><!> <!> <!></div></div></div> <div class="py-2 bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-850"><div class=" flex w-full space-x-2 py-0.5 px-3.5 pb-2"><div class="flex flex-1"><div class=" self-center ml-1 mr-3"><!></div> <input class=" w-full text-sm pr-4 py-1 rounded-r-xl outline-hidden bg-transparent"/> <!></div></div> <div class="px-3 flex w-full bg-transparent overflow-x-auto scrollbar-none -mx-1"><div class="flex gap-0.5 w-fit text-center text-sm rounded-full bg-transparent px-1.5 whitespace-nowrap"><!></div></div> <!></div> <!> <!> <!> <!> <!>`, 1);
var root_26 = from_html(`<div class="w-full h-full flex justify-center items-center"><!></div>`);
...
function Tools($$anchor, $$props) {
  ...
  legacy_pre_effect(() => (get(tools$1), get(query), get(viewOption)), () => {
    if (get(tools$1) && get(query) !== void 0 && get(viewOption) !== void 0) {
      setFilteredItems();
    }
  });
  ...
  var node_1 = sibling(node, 2);
  {
    var consequent_9 = ($$anchor2) => {
      ...
      var node_11 = sibling(div_16, 2);
      {
        ...
        var alternate_2 = ($$anchor3) => {
          ...
          var text_9 = child(div_30, true);
          reset(div_30);
          var div_31 = sibling(div_30, 2);
          var text_10 = child(div_31, true);
          reset(div_31);
          reset(div_29);
          reset(div_28);
          template_effect(
        ...
        if_block(node_11, ($$render) => {
          if (get(filteredItems), untrack(() => (get(filteredItems) ?? []).length !== 0)) $$render(consequent_7);
      ...
      var node_22 = sibling(div_11, 2);
      {
        var consequent_8 = ($$anchor3) => {
          ...
          var text_11 = child(div_33, true);
          reset(div_33);
          var a_2 = sibling(div_33, 2);
          var div_34 = child(a_2);
          var div_35 = child(div_34);
          var text_12 = child(div_35, true);
          reset(div_35);
          var div_36 = sibling(div_35, 2);
          var text_13 = child(div_36, true);
          reset(div_36);
          reset(div_34);
        ...
        ConfirmDialog(node_24, {
          ...
          children: ($$anchor3, $$slotProps) => {
            ...
            template_effect(
              ($02) => {
                set_text(text_14, `${$02 ?? ""} `);
                set_text(text_15, (get(selectedTool), untrack(() => get(selectedTool).name)));
              },
              [
      ...
      ConfirmDialog(node_27, {
        ...
        $$events: {
          confirm: () => {
            ...
            reader.onload = async (event2) => {
              ...
              get(tools$1).set(await getTools(localStorage.token));
            };
        ...
        children: ($$anchor3, $$slotProps) => {
          ...
          var text_16 = child(div_42, true);
          reset(div_42);
          var ul = sibling(div_42, 2);
          var li = child(ul);
          var text_17 = child(li);
          reset(li);
          var li_1 = sibling(li, 2);
          var text_18 = child(li_1, true);
          reset(li_1);
          reset(ul);
          reset(div_41);
          var div_43 = sibling(div_41, 2);
          var text_19 = child(div_43, true);
          reset(div_43);
          reset(div_40);
          template_effect(
            ($0, $1, $2, $3) => {
    ...
    var alternate_3 = ($$anchor2) => {
      var div_44 = root_26();
      var node_28 = child(div_44);
      Spinner(node_28, { className: "size-5" });
      reset(div_44);
      append($$anchor2, div_44);
    };
    if_block(node_1, ($$render) => {
      if (get(loaded)) $$render(consequent_9);
